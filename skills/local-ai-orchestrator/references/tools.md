...
- `local_ai_task`: bounded local generation; default to `qwen2.5-coder:3b-instruct-q5_K_M`, reserve `qwen2.5-coder:7b-instruct-q5_K_M` for complex or high-risk work, and use `qwen2.5-coder:1.5b-instruct-q5_K_M` only for preprocessing after evidence exists.
