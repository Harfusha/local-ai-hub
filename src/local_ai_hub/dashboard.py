...
function renderReviewPresentation(model){
  ...
  if(findings.length)details.push(`<section class="trace-summary-card"><h3>Full finding metadata</h3>${traceHumanReadableMarkup(findingMetadata)}</section>`);
