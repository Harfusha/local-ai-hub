...
function renderAgentLoopPresentation(model){
  ...
  const timelineMarkup=events.length?`<details class="trace-secondary-details trace-agent-timeline" data-trace-collapsible><summary>Execution timeline</summary><div class="trace-optional-body">${traceCodexTimeline({...safeModel,events},'Agent loop',null,true)}</div></details>`:'';
