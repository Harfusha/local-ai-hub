...
- The public MCP surface stays compact. Add capability behind one of the seven existing tools unless a separate schema clearly saves more tokens than it costs.
