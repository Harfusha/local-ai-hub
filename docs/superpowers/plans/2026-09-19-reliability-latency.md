...
- [x] **Step 3: Add one availability gate after cache lookup**
...
- [x] **Step 3: Add the guarded early exit**
...
- Test: `tests/test_review_diff_chunking.py`, `tests/test_async_jobs.py`, `tests/test_delivery_policy.py`

- [x] **Step 1: Add async action coverage**
...
- [x] **Step 2: Add bounded async chunk policy**
...
- [x] **Step 3: Route MCP review diff through automatic delivery**
...
Run: `python -m pytest -q tests/test_review_diff_chunking.py tests/test_async_jobs.py tests/test_delivery_policy.py`
