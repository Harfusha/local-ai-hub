...
from local_ai_hub.services import LocalAIServices, split_review_diff


class ReviewDiffChunkingTests(unittest.TestCase):
    def _services(self, diff_text, estimated_tokens):
    ...
    def test_small_diff_stays_single_request(self):
        ...
        self.assertEqual(calls[0]["complexity"], "auto")
    ...
    def test_large_hunk_is_split_under_budget_and_keeps_heavy_route(self):
        ...
        self.assertTrue(all(estimate_tokens(call["context"]) <= 2400 for call in segment_calls))
    ...
    def test_file_and_hunk_boundaries_are_preserved(self):
        ...
        chunks = split_review_diff(one_file + two_file, max_tokens=256)
