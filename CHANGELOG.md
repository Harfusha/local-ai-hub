...
- Install token-economy CLI wrappers on the user's PATH and allow bounded read-only tools through the command broker; restrict `trim-run` to safe child commands.
