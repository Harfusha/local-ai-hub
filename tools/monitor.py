...
def main()->int:
    ...
    while True:
        ...
        if a.json_lines:
            ...
            print(f"Cache hit: {100*float(o.get('cache_hit_rate',0)):.1f}%  p95: {float(o.get('p95_duration_ms',0)):.0f} ms  Avoided cloud tokens: {int(o.get('cloud_tokens_avoided_est',0)):,}  Fallbacks: {o.get('fallback_count',0)}")
