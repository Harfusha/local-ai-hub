...
token_economy_commands = {
    "tokcount": shutil.which("tokcount"),
    "trim-run": shutil.which("trim-run"),
    "repo-map": shutil.which("repo-map"),
    "grep-ast": shutil.which("grep-ast"),
    "files-to-prompt": shutil.which("files-to-prompt"),
    "ast-grep": shutil.which("ast-grep") or shutil.which("sg"),
    "repomix": shutil.which("repomix"),
    "rg": shutil.which("rg"),
    "fd": shutil.which("fd") or shutil.which("fdfind"),
    "jq": shutil.which("jq"),
}
missing_token_economy_commands = [name for name, command in token_economy_commands.items() if not command]
if missing_token_economy_commands:
    warnings.append("Token-economy commands missing from PATH: " + ", ".join(missing_token_economy_commands) + ". Rerun setup and restart the agent host.")
report["runtime"]["token_economy_commands"] = token_economy_commands
report["runtime"]["missing_token_economy_commands"] = missing_token_economy_commands
